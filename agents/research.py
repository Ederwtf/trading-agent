...
Fuente de precios: Alpaca Market Data (bars diarios, feed IEX), vía agents/broker.py.
Se eligió sobre yfinance porque Yahoo throttlea (timeouts) al analizar muchos símbolos en
batch; Alpaca usa las credenciales que ya tenemos y es estable.
"""
...
def _daily_bars(symbol: str):
    ...
    return broker.daily_bars(symbol, lookback_days=180)
